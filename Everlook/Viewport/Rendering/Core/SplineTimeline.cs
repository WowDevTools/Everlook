...
namespace Everlook.Viewport.Rendering.Core
{
    ...
    /// </typeparam>
    public sealed class SplineTimeline<T> : Timeline<SplineKey<T>>, ITimeline<T> where T : notnull
    {
        /// <inheritdoc />
        public new T Value
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SplineTimeline{T}"/> class. This constructor overrides the
        /// duration of the timeline with the given value.
        /// </summary>
        ...
        (
            ...
            IReadOnlyCollection<SplineKey<T>> values,
            float duration
        )
